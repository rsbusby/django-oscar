...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductClass.mongoItemID'
        db.add_column(u'catalogue_productclass', 'mongoItemID',
                      self.gf('django.db.models.fields.CharField')(max_length=24, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductClass.mongoItemID'
        db.delete_column(u'catalogue_productclass', 'mongoItemID')
