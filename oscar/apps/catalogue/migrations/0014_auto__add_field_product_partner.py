...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_product', 'partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partner.Partner'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.partner'
        db.delete_column(u'catalogue_product', 'partner_id')
