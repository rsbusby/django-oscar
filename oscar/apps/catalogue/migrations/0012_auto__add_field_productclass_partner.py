...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductClass.partner'
        db.add_column(u'catalogue_productclass', 'partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partner.Partner'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductClass.partner'
        db.delete_column(u'catalogue_productclass', 'partner_id')
