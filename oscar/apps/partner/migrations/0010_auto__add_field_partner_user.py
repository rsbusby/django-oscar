...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.user'
        db.add_column(u'partner_partner', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='partner', unique=True, null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.user'
        db.delete_column(u'partner_partner', 'user_id')
