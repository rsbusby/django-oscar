...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.stripePubKey'
        db.add_column(u'partner_partner', 'stripePubKey',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.stripeToken'
        db.add_column(u'partner_partner', 'stripeToken',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.stripePubKey'
        db.delete_column(u'partner_partner', 'stripePubKey')

        # Deleting field 'Partner.stripeToken'
        db.delete_column(u'partner_partner', 'stripeToken')
