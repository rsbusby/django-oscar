...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StockRecord.is_shippable'
        db.add_column(u'partner_stockrecord', 'is_shippable',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StockRecord.is_shippable'
        db.delete_column(u'partner_stockrecord', 'is_shippable')
