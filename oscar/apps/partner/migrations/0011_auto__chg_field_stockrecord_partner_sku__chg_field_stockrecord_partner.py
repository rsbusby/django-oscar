...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StockRecord.partner_sku'
        db.alter_column(u'partner_stockrecord', 'partner_sku', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'StockRecord.partner'
        db.alter_column(u'partner_stockrecord', 'partner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partner.Partner'], null=True))

    def backwards(self, orm):

        # Changing field 'StockRecord.partner_sku'
        db.alter_column(u'partner_stockrecord', 'partner_sku', self.gf('django.db.models.fields.CharField')(default=0, max_length=128))

        # Changing field 'StockRecord.partner'
        db.alter_column(u'partner_stockrecord', 'partner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['partner.Partner']))
