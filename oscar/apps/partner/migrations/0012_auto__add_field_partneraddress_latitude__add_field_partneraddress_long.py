...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerAddress.latitude'
        db.add_column(u'partner_partneraddress', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PartnerAddress.longitude'
        db.add_column(u'partner_partneraddress', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StockRecord.latitude'
        db.add_column(u'partner_stockrecord', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StockRecord.longitude'
        db.add_column(u'partner_stockrecord', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerAddress.latitude'
        db.delete_column(u'partner_partneraddress', 'latitude')

        # Deleting field 'PartnerAddress.longitude'
        db.delete_column(u'partner_partneraddress', 'longitude')

        # Deleting field 'StockRecord.latitude'
        db.delete_column(u'partner_stockrecord', 'latitude')

        # Deleting field 'StockRecord.longitude'
        db.delete_column(u'partner_stockrecord', 'longitude')
