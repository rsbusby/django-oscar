...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StockRecord.shipping_options'
        db.add_column(u'partner_stockrecord', 'shipping_options',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StockRecord.shipping_options'
        db.delete_column(u'partner_stockrecord', 'shipping_options')
    ...
    models = {
        ...
        u'partner.stockrecord': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_shippable': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'latitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'local_pickup_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'longitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'low_stock_threshold': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'made_to_order': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            ...
            'partner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['partner.Partner']", 'null': 'True', 'blank': 'True'}),
            'partner_sku': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
