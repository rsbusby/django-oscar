...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StockRecord.weight'
        db.add_column(u'partner_stockrecord', 'weight',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StockRecord.weight'
        db.delete_column(u'partner_stockrecord', 'weight')
