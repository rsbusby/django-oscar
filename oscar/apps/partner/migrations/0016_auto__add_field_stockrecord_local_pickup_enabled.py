...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StockRecord.local_pickup_enabled'
        db.add_column(u'partner_stockrecord', 'local_pickup_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StockRecord.local_pickup_enabled'
        db.delete_column(u'partner_stockrecord', 'local_pickup_enabled')
