...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.bio'
        db.add_column(u'partner_partner', 'bio',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.zipcode'
        db.add_column(u'partner_partner', 'zipcode',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.bio'
        db.delete_column(u'partner_partner', 'bio')

        # Deleting field 'Partner.zipcode'
        db.delete_column(u'partner_partner', 'zipcode')
