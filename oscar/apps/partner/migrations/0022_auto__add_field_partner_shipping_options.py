...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.shipping_options'
        db.add_column(u'partner_partner', 'shipping_options',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.shipping_options'
        db.delete_column(u'partner_partner', 'shipping_options')
