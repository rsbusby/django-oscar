...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StockRecord.made_to_order'
        db.add_column(u'partner_stockrecord', 'made_to_order',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StockRecord.made_to_order'
        db.delete_column(u'partner_stockrecord', 'made_to_order')
