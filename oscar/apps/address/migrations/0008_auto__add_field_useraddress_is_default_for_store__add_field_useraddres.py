...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAddress.is_default_for_store'
        db.add_column(u'address_useraddress', 'is_default_for_store',
    ...
    def backwards(self, orm):
        # Deleting field 'UserAddress.is_default_for_store'
        db.delete_column(u'address_useraddress', 'is_default_for_store')
    ...
    models = {
        ...
        u'address.useraddress': {
            ...
            'is_default_for_store': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
