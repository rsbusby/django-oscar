...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAddress.location_name'
        db.add_column(u'address_useraddress', 'location_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAddress.location_name'
        db.delete_column(u'address_useraddress', 'location_name')
