...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.sender'
        db.add_column(u'customer_email', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sent_emails', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Email.sender'
        db.delete_column(u'customer_email', 'sender_id')
    ...
    models = {
        ...
        u'customer.email': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sent_emails'", 'null': 'True', 'to': u"orm['auth.User']"}),
