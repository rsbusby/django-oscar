...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basket.shipping_info'
        db.add_column(u'basket_basket', 'shipping_info',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Basket.shipping_info'
        db.delete_column(u'basket_basket', 'shipping_info')
    ...
    models = {
        ...
        u'basket.basket': {
            ...
            'shipping_info': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
