...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Basket.benefit_org'
        db.alter_column(u'basket_basket', 'benefit_org_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.SponsoredOrganization'], null=True))

    def backwards(self, orm):

        # Changing field 'Basket.benefit_org'
        db.alter_column(u'basket_basket', 'benefit_org_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.BenefitOrganization'], null=True))
    ...
    models = {
        ...
        u'basket.basket': {
            ...
            'benefit_org': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['order.SponsoredOrganization']", 'null': 'True', 'blank': 'True'}),
