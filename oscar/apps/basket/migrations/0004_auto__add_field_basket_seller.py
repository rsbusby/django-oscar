...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basket.seller'
        db.add_column(u'basket_basket', 'seller',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='baskets', null=True, to=orm['partner.Partner']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Basket.seller'
        db.delete_column(u'basket_basket', 'seller_id')
