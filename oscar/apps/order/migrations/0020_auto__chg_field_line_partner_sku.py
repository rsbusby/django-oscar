...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Line.partner_sku'
        db.alter_column(u'order_line', 'partner_sku', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Line.partner_sku'
        db.alter_column(u'order_line', 'partner_sku', self.gf('django.db.models.fields.CharField')(default='', max_length=128))
