...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.shipping_rate_id'
        db.add_column(u'order_order', 'shipping_rate_id',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.shipping_carrier'
        db.add_column(u'order_order', 'shipping_carrier',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.shipping_service'
        db.add_column(u'order_order', 'shipping_service',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.shipping_info_json'
        db.add_column(u'order_order', 'shipping_info_json',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.shipping_label_json'
        db.add_column(u'order_order', 'shipping_label_json',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.shipping_rate_id'
        db.delete_column(u'order_order', 'shipping_rate_id')

        # Deleting field 'Order.shipping_carrier'
        db.delete_column(u'order_order', 'shipping_carrier')

        # Deleting field 'Order.shipping_service'
        db.delete_column(u'order_order', 'shipping_service')

        # Deleting field 'Order.shipping_info_json'
        db.delete_column(u'order_order', 'shipping_info_json')

        # Deleting field 'Order.shipping_label_json'
        db.delete_column(u'order_order', 'shipping_label_json')
