...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsoredOrganization.is_current'
        db.add_column(u'order_sponsoredorganization', 'is_current',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SponsoredOrganization.is_current'
        db.delete_column(u'order_sponsoredorganization', 'is_current')
