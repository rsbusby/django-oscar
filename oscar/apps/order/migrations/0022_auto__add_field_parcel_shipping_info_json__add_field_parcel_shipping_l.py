...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parcel.shipping_info_json'
        db.add_column(u'order_parcel', 'shipping_info_json',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Parcel.shipping_label_json'
        db.add_column(u'order_parcel', 'shipping_label_json',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Parcel.shipping_info_json'
        db.delete_column(u'order_parcel', 'shipping_info_json')

        # Deleting field 'Parcel.shipping_label_json'
        db.delete_column(u'order_parcel', 'shipping_label_json')
