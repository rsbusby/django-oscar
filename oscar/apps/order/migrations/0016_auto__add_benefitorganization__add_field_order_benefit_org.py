...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'order.benefitorganization': {
            'Meta': {'object_name': 'BenefitOrganization'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'order.order': {
            ...
            'benefit_org': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['order.BenefitOrganization']", 'null': 'True', 'blank': 'True'}),
