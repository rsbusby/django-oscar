...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'BenefitOrganization'
        db.delete_table(u'order_benefitorganization')

        # Adding model 'SponsoredOrganization'
        db.create_table(u'order_sponsoredorganization', (
        ...
        db.send_create_signal(u'order', ['SponsoredOrganization'])

        # Deleting field 'Order.benefit_org'
        db.delete_column(u'order_order', 'benefit_org_id')

        # Adding field 'Order.sponsored_org'
        db.add_column(u'order_order', 'sponsored_org',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.SponsoredOrganization'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'BenefitOrganization'
        db.create_table(u'order_benefitorganization', (
            ('status', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('website', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'order', ['BenefitOrganization'])

        # Deleting model 'SponsoredOrganization'
        db.delete_table(u'order_sponsoredorganization')

        # Adding field 'Order.benefit_org'
        db.add_column(u'order_order', 'benefit_org',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.BenefitOrganization'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Order.sponsored_org'
        db.delete_column(u'order_order', 'sponsored_org_id')
